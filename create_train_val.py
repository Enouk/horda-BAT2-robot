...
DATASET_DIR = os.path.abspath(os.path.join(CURRENT_DIR, '../../../datasets/horda-scanner-dataset/images'))
...
background_train = background_images[:int(len(background_images)*0.9)]
background_test = background_images[int(len(background_images)*0.9):]

good_train = good_images[:int(len(good_images)*0.9)]
good_test = good_images[int(len(good_images)*0.9):]
 
bad_train = bad_images[:int(len(bad_images)*0.9)]
bad_test = bad_images[int(len(bad_images)*0.9):]
